...
class CameraModel:
    ...
    def triangulate_all_observations(self) -> NDArray:
        return np.array([])
    ...
    def triangulate_two_observations(
        ...
        """
        Returns the triangulated points from two observations
        """
        proj_matrix1 = self.get_projection_matrix(
            observation1.odom_position,
            observation1.odom_orientation
        )

        proj_matrix2 = self.get_projection_matrix(
